...
const Modal: React.FC<IModal> = ({ onHandleChoise, incident, isDarkMode }) => {
  return (
    <>
      <button
        type="button"
      ...
      <div
        className="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto dark"
        id="staticBackdrop"
        ...
        <div className="modal-dialog relative w-auto pointer-events-none">
          <div
            className={`modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-clip-padding rounded-md outline-none text-current ${
              isDarkMode ? "dark:bg-[#0c081c]" : "bg-white"
            }`}
          >
            ...
            <div className="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md select-none">
              <button
                className={`
                  mr-2 
                  bg-blue-500 
                  ...
                  active:bg-blue-500 hover:bg-blue-600 hover:shadow-lg transition duration-150 ease-in-out`}
              ...
              <button
                className={`
                  ...
                  rounded 
                  shadow-md 
                  hover:bg-red-700 hover:shadow-lg transition duration-150 ease-in-out`}
                data-bs-dismiss="modal"
